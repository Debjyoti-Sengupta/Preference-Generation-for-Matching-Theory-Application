...
v1={'pos':(5,2), 'avg_vel': 7, 'deadline':5, 'data': 200}
v2={'pos':(7,3), 'avg_vel': 4, 'deadline':10, 'data': 270}
v3={'pos':(2,1), 'avg_vel': 2, 'deadline':7, 'data': 300}
v4={'pos':(2,5), 'avg_vel': 8, 'deadline':4, 'data': 250}
v5={'pos':(4,2), 'avg_vel': 10, 'deadline':4, 'data': 400}
...
for k in VU_List.keys():
    ...
    for l in VM_List.keys():
        latency= 2*(VU_List[k]['data']/rsucomm_bitrate[k]) + (VM_List[l]['ohm'])/(VM_List[l]['c']*VM_List[l]['f'])
